...
// selfUpdateSysProcAttr returns SysProcAttr with DETACHED_PROCESS | CREATE_NEW_PROCESS_GROUP
// so the restarted process survives after the parent calls os.Exit.
