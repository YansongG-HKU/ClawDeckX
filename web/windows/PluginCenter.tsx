...
const PLUGIN_CATALOG: CatalogEntry[] = [
  ...
  { id: 'wecom-app', spec: '@wecom/wecom-openclaw-plugin-app', name: 'WeCom App (KF)', nameZh: '企业微信客服', description: 'WeCom customer service app plugin', descriptionZh: '企业微信客服应用插件', icon: '🎧', category: 'channel', relatedChannels: ['wecom_kf'] },
